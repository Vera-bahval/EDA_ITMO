...
- **Временной паттерн**: Ночные часы (1-4) дают 59% fraud vs 10% днем (5.9x разница)
...
1. Автоматическое снижение лимитов в период 01:00-05:00
...
1. Блокировка карты после 2-3 операций <$10 за час
...
**Продуктовая гипотеза:** Блокировка операций при первой транзакции в новой стране до подтверждения клиентом снизит fraud примерно на 35%
...
**Продуктовая гипотеза:** Создание "белого списка" проверенных терминалов и блокировка подозрительных точек снизит физическое мошенничество
...
**Продуктовая гипотеза:** Динамические лимиты на основе истории снизят false positive и улучшат UX
